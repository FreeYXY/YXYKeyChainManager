#
#  Be sure to run `pod spec lint YXYKeyChainManager.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "YXY"
  # spec.authors            = { "YXY" => "yangxiaoyang@techwis.cn" }
  # spec.social_media_url   = "https://twitter.com/YXY"
